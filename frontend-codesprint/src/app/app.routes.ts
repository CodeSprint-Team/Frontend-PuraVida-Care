...
export const routes: Routes = [
  ...
  // Proveedor - Servicio / Booking
  { path: 'provider-requests-service',    component: ProviderRequestsComponent },
  { path: 'provider-booking-detail/:id',  component: ProviderBookingDetail },
  { path: 'provider-start-service/:id',   component: ProviderStartBooking },
  { path: 'provider-in-service/:id',      component: ProviderInService },
  ...
  // Tracking
  { path: 'family-tracking/:sessionId', component: FamilyTrackingComponent },
